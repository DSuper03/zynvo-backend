...
router.post('/announcement/:eventId',AuthMiddleware, ClubHeadAuthMiddleware, createAnnouncement);
router.put('/announcement/:eventId',AuthMiddleware, ClubHeadAuthMiddleware, updateAnnouncement);
router.delete('/announcement/:eventId',AuthMiddleware, ClubHeadAuthMiddleware, deleteAnnouncement);
router.post('/:eventId/gallery', SpecificClubHeadAuthMiddleware, addToGallery);
router.get('/:eventId/gallery', getEventGallery);
router.put('/:eventId/gallery',AuthMiddleware, ClubHeadAuthMiddleware, updateGalleryItem);
router.delete('/:eventId/gallery',AuthMiddleware, ClubHeadAuthMiddleware, deleteGalleryItem);
